...
<template>
    <div class="flex items-center absolute top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50">
        <div class="w-1/2 mx-auto border rounded bg-white p-3">
            ...
            <div class="mt-4 space-y-2">
                ...
                <button class="w-full rounded text-white bg-gray-600 hover:bg-gray-800 p-3">Confirmar</button>
            </div>
        </div>
    </div>
</template>