...
<template>
    <dialog v-show="isVisibleAlert" class="flex items-center absolute top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50">
        <div class="w-96 lg:w-1/2 xl:w-1/4 mx-auto border rounded bg-white p-3">
            ...
            <div class="mt-4 space-y-2">
                <div class="flex items-center">
                    <input type="checkbox" id="notShowAgain" class="rounded" v-model="notShowAgain">
